        ...
        do {
            ...
            switch (opcion) {
                case "1" -> {
                    ...
                    Productos[] getListaProductos = gestion.getListaProductos();
                ...
                case "3" -> {
                    ...
                    valorString = entrantScanner.next();
                    Productos[] productosFrescosPorPais = gestion.productosFrescosPorPais(valorString);
                ...
                case "4" -> {
                    ...
                    Productos[] productosCaducados = gestion.getProductosCaducados();
                ...
                case "5" -> {
                    ...
                    valorString = entrantScanner.next();
                    Productos[] producTipe = gestion.getProductTipe(valorString);
