...
public class PreoductosCongelados extends Productos {
    private double temperaturaRecomendadaCong;

    public PreoductosCongelados(int id_Producto, String descripcion, LocalDate fecha_Caaducidad, int numLote, double temperaturaRecomendadaCong) {
